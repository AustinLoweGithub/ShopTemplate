...
namespace ShopTemplate.Api.Data
{
    public class ShopTemplateDbContext: DbContext
    {

        public ShopTemplateDbContext(DbContextOptions<ShopTemplateDbContext> options) : base(options)
        {
